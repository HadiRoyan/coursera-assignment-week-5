    ...
    when (direction) {
        Direction.UP -> {
            for (i in 1..width) {
                ...
                for (j in 1..width) {
                    column.add(getCell(j, i))
                }
                condition = moveValuesInRowOrColumn(column) || condition
            }
        }
        ...
        Direction.DOWN -> {
            for (i in 1..width) {
                ...
                condition = moveValuesInRowOrColumn(column.reversed()) || condition
            }
        }
        ...
        Direction.LEFT -> {
            for (i in 1..width) {
                ...
                condition = moveValuesInRowOrColumn(row) || condition
            }
        }
        ...
        Direction.RIGHT -> {
            for (i in 1..width) {
                val row = getRow(i, 1..width)
                condition = moveValuesInRowOrColumn(row.reversed()) || condition
            }
        }
    }
